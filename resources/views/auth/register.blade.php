        ...
        <div class="mx-auto rounded">
            <ul id="tabs" class="inline-flex w-full px-1">
                <li class="px-4 py-2 -mb-px font-semibold text-gray-800 border-b-2 border-blue-400 rounded-t">
                    <a id="default-tab" href="#customer">
                        Customer
                    </a>
                </li>
            ...
            <div id="tab-contents">
                ...
                <div id="restaurant" class="hidden p-4">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        ...
                        <div class="mt-4">
                            <x-label for="name" :value="__('Restaurant Description')" />
        ...
        <script>
            ...
            tabTogglers.forEach(function(toggler) {
                toggler.addEventListener("click", function(e) {
                    ...
                    e.target.parentElement.classList.add("border-blue-400", "border-b-2", "-mb-px",
                        "opacity-100");
                });
            });
